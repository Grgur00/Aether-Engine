...
include(
    ...
    ":modules:aether-security-api",
    ":modules:aether-security-core",
    ":modules:aether-crypto",
    ":modules:aether-config",
    ":modules:aether-observability-api",
    ":modules:aether-reliability",
    ":modules:aether-release",
    ":modules:aether-admission",
