...
public interface RpcServer extends AutoCloseable {
    ...
    /** Returns the actual bound endpoint, including an assigned ephemeral port. */ RpcEndpoint endpoint();
    /** Gracefully stops admission and releases the listener. */ @Override void close();
}
