...
public final class NativeAccess {
    ...
    private static final ValueLayout.OfInt ALIGNED_INT =
    ...
    public static int compareUnsigned(
            MemorySegment segment, long offset, int length, byte[] candidate) {
