...
public interface NativeAllocator {
    ...
    record Allocation(boolean allocated, int offset, int length) {
        public static Allocation full() { return new Allocation(false, 0, 0); }
        public static Allocation at(int offset, int length) { return new Allocation(true, offset, length); }
    }
}
