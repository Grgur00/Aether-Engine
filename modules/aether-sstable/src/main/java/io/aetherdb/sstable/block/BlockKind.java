...
public enum BlockKind {
    /** Sorted internal-key/value records. */
    DATA(1),
    /** Data-block upper-bound keys and handles. */
    INDEX(2),
    /** Full-file user-key Bloom filter. */
    FILTER(3),
    /** Required immutable table properties. */
    PROPERTIES(4),
    /** Named metadata block handles. */
    METAINDEX(5);
