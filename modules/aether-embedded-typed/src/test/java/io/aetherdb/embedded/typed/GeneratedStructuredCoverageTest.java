...
class GeneratedStructuredCoverageTest {
    @Test void stableEnumAndNestedRecordRoundTripWithoutReflection() {
        Delivery expected = new Delivery(
                DeliveryStatus.IN_TRANSIT, new PostalAddress("Zagreb", "10000"));
        ...
        assertThat(new String(GeneratedCodecs.descriptor(codec.schemaId(), 1).orElseThrow(),
                java.nio.charset.StandardCharsets.UTF_8)).contains("|ENUM|").contains("|NESTED|");
    }
}
