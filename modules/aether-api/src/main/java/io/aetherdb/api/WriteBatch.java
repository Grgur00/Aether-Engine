...
public final class WriteBatch implements AutoCloseable {
    ...
    public enum State {
        /** Accepting mutations. */ OPEN,
        /** Claimed by a writer but not yet submitted. */ SEALED,
        /** Submitted past the implementation's uncertainty boundary. */ SUBMITTED,
        /** Applied successfully. */ SUCCEEDED,
        /** Failed with a definite non-commit outcome. */ FAILED,
        /** Final commit outcome is unknown. */ INDETERMINATE,
        /** Closed before submission. */ CLOSED
    }
