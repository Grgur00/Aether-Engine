...
public final class FollowerProgress {
    ...
    public enum Mode {
        /** Send a bounded probe while searching for a matching prefix. */ PROBE,
        /** Pipeline entries after establishing a matching prefix. */ REPLICATE,
        /** Stop incremental replication and install a snapshot. */ SNAPSHOT_REQUIRED
    }
