...
public final class StableConfigurationV2 implements StableConfiguration {
    private final StableConfigurationV1 base;
    private final UUID transitionId;
    private final int changedMembers;
     ...
     */
    public StableConfigurationV2(
            UUID clusterId,
            long version,
            UUID configurationId,
            byte[] previousHash,
            UUID completedTransitionId,
        ...
        base =
                new StableConfigurationV1(
                        clusterId, version, configurationId, previousHash, members, created, hash);
        if (completedTransitionId == null || changedMembers < 0 || changedMembers > 16)
            throw new IllegalArgumentException("invalid transition metadata");
     ...
     */
    public UUID completedTransitionId() {
        return transitionId;
    }
    ...
    public long creationEpochMillis() {
        return base.creationEpochMillis();
    }
